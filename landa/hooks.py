...
doctype_list_js = {
	...
	"Sales Invoice": "landa_sales/sales_invoice/sales_invoice_list.js",
	"Sales Order": "landa_sales/sales_order/sales_order_list.js",
	"Delivery Note": "landa_stock/delivery_note/delivery_note_list.js",
}
...
doc_events = {
	...
	"Sales Invoice": {
		...
		"validate": "landa.landa_sales.sales_invoice.sales_invoice.validate",
...
scheduler_events = {
	...
	"cron": {
		...
		"0 0 1 1 *": [  # every 1st january at 00:00
			...
			"landa.organization_management.doctype.yearly_fishing_permit_gewaesserfonds.yearly_fishing_permit_gewaesserfonds.update_gewaesserfonds_permit_statuses",
		],
	},
	# "all": ["landa.tasks.all"],
	# 	, "hourly": [
