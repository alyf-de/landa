...
class LANDAMemberFunction(object):
	...
	def get_data(self):
		...
		member_df['upcoming_birthday']=[calculate_upcoming_birthday(bd) for bd in member_df['date_of_birth'].values]
		# calculate if decadal birthday
		member_df['is_decadal_birthday']=[calculate_decadal_birthday(bd) for bd in member_df['date_of_birth'].values]
