...
from landa.organization_management.doctype.external_function.external_function import get_active_external_functions
...
class ExternalFunctionCategory(Document):
	def get_external_contact_names(self):
		...
		external_contact_names = get_active_external_functions(filters=filters, pluck='external_contact')
